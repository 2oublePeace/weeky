...
class UserControllerIT {
    ...
    @Test
    fun createUserTest() {
        val userRequest = UserRequest("user", "password", "USER")
    ...
    fun updateUserTest() {
        ...
        val updatedRequest = UserRequest("updatedUser", "updatedPassword", "USER")
        ...
        mockMvc.perform(
            ...
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.username").value(updatedRequest.username))
            .andExpect(jsonPath("$.password").value(updatedRequest.password))
            .andExpect(jsonPath("$.role").value(updatedRequest.role))
    }
